          ...
          <form onSubmit={handleSubmit(customSubmit)} onChange={() => setZipcode(getValues().zipcode)}  className='d-flex row gx-5'>
            <div className='col-lg-6 col-sm-12'>Solicitud de adopción:
              ...
              <input 
                    ...
                    aria-describedby='basic-addon1' 
                    />
              {errors.zip?.type === 'required' && <small className='text-danger'>Por favor escriba su código Postal de 5 dígitos</small>}
              <input 
                    type='text' 
                    className='form-control mt-2'
                    placeholder='Estado' 
            ...
            <div className='col-lg-6 col-sm-12'>
              ...
              <select 
                    ...
                    {...register('livingPlace', { required: true })} 
              ...
              <input 
                    type='number' 
                    className='form-control mt-2' 
                    {...register('roomies', { required: true })} 
                    min='0' 
                    max='10' 
                    />
              ...
              <div className='d-flex'>
                <div className='form-check'>
                  <input 
                      ...
                      {...register('roomiesAgreement', { required: true })} 
                      type='radio' 
                      value='si' 
                      id='flexRadioDefault' 
                  />
              ...
              <div className='d-flex'>
                <div className='form-check'>
                  <input 
                      className={`form-check-input ${styles.formCheck}`} 
                      {...register('pastPets', { required: true })} 
                      type='radio' 
                      value='si' 
              ...
              <input 
                    type='text' 
                    className='form-control' 
                    {...register('moveInScenario', { required: true })} 
                    aria-describedby='addon-wrapping' />
              ...
              <input 
                    type='text' 
                    className='form-control' 
                    {...register('hardEconomicSituationScenario', { required: true })} 
                    aria-describedby='addon-wrapping' 
              />
              ...
              <button 
                  type='submit' 
                  className={`btn btn-secondary mt-3 ${styles.btnOrange}`}>
                    <img alt='pet-paw' src='pet_paw.svg' width={25} className='me-2'></img> Solicitar validación
              </button>
